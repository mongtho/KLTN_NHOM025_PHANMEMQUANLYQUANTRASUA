...
const styles = StyleSheet.create({
  ...
  aiModalContainer: {
    backgroundColor: 'white',
    borderTopLeftRadius: sw(42),
    borderTopRightRadius: sw(42),
    paddingBottom: sh(40),
    minHeight: sh(360),
    alignItems: 'center',
  },
  ...
  aiHeaderIcon: { fontSize: sw(28), color: '#CA3500' },
  ...
  aiSubtitleHighlight: { color: '#F54900', fontWeight: '700' },
  ...
  suggestionImg: { fontSize: sw(30) },
  suggestionInfo: { flex: 1 },
  suggestionName: { color: '#1E2939', fontSize: mod(16), fontWeight: '700' },
  suggestionPrice: { color: '#F54900', fontSize: mod(14), fontWeight: '700', marginTop: 4 },
  suggestionAddBtn: {
    width: sw(32),
    height: sw(32),
    borderRadius: sw(16),
  ...
  suggestionAddIcon: { fontSize: mod(16), color: '#F54900', fontWeight: 'bold' },
  ...
  noThanksText: { color: 'white', fontSize: mod(15), fontFamily: 'Poppins', fontWeight: '700' },
